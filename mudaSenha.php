<?php
    ...
    if($_POST){
        ...
        if($num_rows == 0){
            ...
            $msg = 'Link de alteração expirado!';
            ...
            $sql = 'UPDATE tbl_usuario SET senha = :senha, token = 0 WHERE token = :token;';
            $stmt = $PDO->prepare($sql);
            $stmt->bindValue(':token', $token);
                    ...
                    <div class="box-login shadow">
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="novasenha" placeholder="Repita a senha" required>
                            </div>
                            <input type="hidden" value="<?php echo $token ?>" name="token">
                            <button type="submit" class="btn btn-primary" id="btn">Mudar</button>
                        </form>
                        <div class="b2">
